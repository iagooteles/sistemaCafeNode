...
export class BillService {
  ...
  getBills() {
    return this.httpClient.get(`${this.url}/bill/getBills`, { headers:this.getHeaders() });
  }

  delete(id: any) {
    return this.httpClient.delete(`${this.url}/bill/deleteBill/${id}`, { headers:this.getHeaders() });
  }
}
